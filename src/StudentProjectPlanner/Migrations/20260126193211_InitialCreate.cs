        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GroupProjectId = table.Column<int>(type: "INTEGER", nullable: false),
                    UserId = table.Column<string>(type: "TEXT", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProjectMembers_GroupProjects_GroupProjectId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProjectTasks_GroupProjects_GroupProjectId",
                        column: x => x.GroupProjectId,
                        principalTable: "GroupProjects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Courses_UserId_CourseCode",
                table: "Courses",
                columns: new[] { "UserId", "CourseCode" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ProjectMembers_GroupProjectId_UserId",
                table: "ProjectMembers",
                columns: new[] { "GroupProjectId", "UserId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectTasks_GroupProjectId",
                table: "ProjectTasks",
